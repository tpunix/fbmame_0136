...
struct _game_driver_info
{
	void *magic;
	const struct _game_driver *driver;
};
...
struct _game_driver_info __attribute__((section (".game_driver"))) __add_driver_##NAME = {(void*)0x9a0ed15e, &GAME_NAME(NAME)};
